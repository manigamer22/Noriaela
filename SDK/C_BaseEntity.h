...
public:
    ...
    {
        return *(unsigned long*)((uintptr_t)this + offsets.DT_BaseCombatCharacter.m_hActiveWeapon);
    }

    unsigned long GetViewModel()
    {
        return *(unsigned long*)((uintptr_t)this + offsets.DT_BasePlayer.m_hViewModel);
    }
